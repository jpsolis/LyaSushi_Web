...
function ejecutarAccion(accion, idRelleno, descripcion, cobroExtra, valorExtra, codigoRelleno)
{
    ...
    if(accion == "Editar")
    {
        ...
        let url = "http://www.apirestaurant.somee.com/api/Relleno/Editar/";
        let registro = {
        "idRelleno": idRelleno,
        ...
        let url = "http://www.apirestaurant.somee.com/api/Relleno/Eliminar/" +idRelleno;
        console.log("URL: " +url);
       ...
       location.reload();
        ...
        let url = "http://www.apirestaurant.somee.com/api/Relleno/Guardar/";
        console.log("URL: " +url);
...
function cargarGrilla()
{
    ...
    fetch('http://www.apirestaurant.somee.com/api/Relleno/Lista/')
    ...
    .then((data) => {
     ...
     for(let i = 0; i < data.response.length; i++){
        ...
        <td data-cell="valor extra">${data.response[i].valorExtra}</td>        
